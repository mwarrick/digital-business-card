...
<head>
    ...
    <title>Email Signatures – ShareMyCard</title>
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="intro">
            <h2 style="margin:0 0 10px 0; color:#333;">Create a professional email signature</h2>
            <p class="muted" style="margin:0 0 10px 0;">
                Generate a polished email signature based on one of your business cards. We'll pull your name, title,
                company, and contact info, and give you a copy-paste signature that looks great in major email clients.
            </p>
            <ul class="muted" style="margin:0 0 0 18px; line-height:1.8;">
                <li>Matches your card branding</li>
                <li>Includes QR code and links (optional)</li>
        ...
        <?php if (!$hasCards): ?>
            <div class="empty">
                ...
                <p class="muted" style="margin:0 0 16px 0;">Create a card first, then come back to generate a signature.</p>
        ...
        <?php else: ?>
            ...
            <div class="cards-grid">
                ...
                <div class="card-item">
                    ...
                    <?php endif; ?>
                    <div class="actions">
                        <a class="btn btn-primary" href="/user/cards/email-signature.php?card_id=<?php echo urlencode($card['id']); ?>">Use This Card</a>
