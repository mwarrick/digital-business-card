<?php
/**
 * Email Signature Generator - Admin Version
...
// Get card details (admins can view any card)
...
<head>
    ...
    <title><?php echo $pageTitle; ?> - ShareMyCard Admin</title>
...
<body>
    ...
    <div class="signature-container">
        <a href="/admin/cards/view.php?id=<?php echo urlencode($cardId); ?>" class="back-link">
            ← Back to Card
        </a>
