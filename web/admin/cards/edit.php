    ...
    if (empty($firstName)) {
        ...
        try {
            ...
            if (!empty($uploadedImages)) {
                ...
                $updateValues[] = $cardId;
                $updateValues[] = AdminAuth::getUserId();
            ...
            // Redirect to view
            header('Location: /admin/cards/view.php?id=' . urlencode($cardId) . '&updated=1');
            exit;
        ...
        <div class="form-container">
            ...
            <form method="POST" action="" id="cardForm" enctype="multipart/form-data">
                        ...
                        <?php if (!empty($card['profile_photo_path'])): ?>
                            <div style="margin-bottom: 10px;">
                                <img src="/api/media/view?filename=<?php echo urlencode($card['profile_photo_path']); ?>" 
                                     ...
                                     style="width: 150px; height: 150px; object-fit: cover; border-radius: 50%; border: 3px solid #667eea;">
                ...
                <div class="form-actions">
                    <a href="/admin/cards/view.php?id=<?php echo urlencode($cardId); ?>" class="btn btn-secondary">Cancel</a>
